<template>
  <div>
    ...
    <!-- nav of icon end -->
    <m-card icon="Menu" title="新闻资讯" image="">
      <!-- <img class="w-100" src="../assets/images/20796372351730.jpg"> -->
    ...
    <m-card icon="Menu" title="英雄列表" image="../assets/images/20796372351730.jpg"></m-card>
  </div>
</template>
