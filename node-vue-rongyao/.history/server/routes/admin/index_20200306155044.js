 ...
 * @Last Modified time: 2020-03-06 15:49:33
 */
module.exports = app =>{
    ...
    app.post("/admin/api/login",async(req,res)=>{
      ...
      //3.返回token
      //首先安装jsonwebtoken模块，做web的token验证  npm i jsonwebtoken  
      const jwt = require('jsonwebtoken');
      jwt.sign({id:user._id},app.get('secret')) //只能传一个参数，这里的get跟路由的get其实名字是冲突了的（重名了），这里通过参数名来确定是定义路由还是获取配置
    })
