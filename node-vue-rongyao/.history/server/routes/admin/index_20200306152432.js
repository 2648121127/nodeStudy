 ...
 * @Last Modified time: 2020-03-06 15:22:48
 */
module.exports = app =>{
    ...
    app.post("/admin/api/login",async(req,res)=>{
      ...
      const isValid = require('bcryptjs').compareSync(password,user.password); // compareSync比较这两个是否相同 password明文，用户提交上来的密码  user.password密文，加密后的密码，数据库获取的到的
